...
st.title("PERBANDINGAN EKSTRAKSI CIRI WARNA PADA ALGORITMA K-NEAREST NEIGHBORS DALAM KLASIFIKASI TINGKAT KEMATANGAN SAWIT")
...
if d_RGB:
        ...
        dplot= px.scatter_3d(RGB,  x='R', y='G', z='B',
                color='Class')
        st.write("3d plot dataset RGB")
        st.write(dplot)
# button crop
